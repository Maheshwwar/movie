...
<div class="main">
  <div class="header">
    ...
    <div class="hbg"><img src="images/header_images.jpg" width="653" height="271" alt="" />
      <div class="text">
        <p class="style1">Collaborative filtering, content-based filtering, </p>
        <p class="style1">recommendation system (RS), </p>
        <p class="style1">sentiment analysis, </p>
        <p class="style1">Twitter</p>
        <h3>&nbsp;</h3>
      </div>
    </div>
  </div>
