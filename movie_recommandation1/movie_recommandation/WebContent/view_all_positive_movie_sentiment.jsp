...
<div class="main">
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2 class="style3">View all positive movie tweet sentiment</h2>
          <div class="clr"></div>
          <p>&nbsp;</p>
          <p><%
...
try 
	{
		...
		while(rs2.next())
		{
					...
					while(rs.next())
					{
							...
							totalcmts=totalcmts+1;
								...
								if ((s5.indexOf(ta1)>=0 || s5.indexOf(ta2)>=0 
									 ...
									 || s5.indexOf(n96)>=0	|| s5.indexOf(n97)>=0 || s5.indexOf(n98)>=0 || s5.indexOf(n99)>=0 || s5.indexOf(n100)>=0)  && (s5.indexOf(nt1)>=0 || s5.indexOf(nt2)>=0|| s5.indexOf(nt1)>=0   || s5.indexOf(nt2)>=0  || s5.indexOf(nt3)>=0  || s5.indexOf(nt4)>=0  || s5.indexOf(nt5)>=0 
		  ...
		  <table width="546" height="98" border="1" align="left" cellpadding="0" cellspacing="0" >
              ...
              <tr>
                <td height="20" colspan="3" bgcolor="#0000FF"><div align="center"><span class="style36 style15 style10">Positive Reviews on Movie::-----&gt; <%=s2%></span></div></td>
              </tr>
