...
<div class="main">
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2 class="style3">View All Reviewed Movies Tweets </h2>
          <div class="clr"></div>
          <p>&nbsp;</p>
          <p><%
...
<table width="669" border="0" align="center">
  ...
  <tr>
    <td bgcolor="#FFFF00"><div align="left" class="style5 style7">Reviewed By</div></td>
    <td><span class="style9"><%=s4%></span></td>
  </tr>
  <tr>
    <td bgcolor="#FFFF00"><div align="left" class="style5 style7">Review Details</div></td>
  ...
  <tr>
    <td bgcolor="#FFFF00"><div align="left" class="style5 style7">View the Topic</div></td>
